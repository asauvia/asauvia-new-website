        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {["share", "rss_feed", "alternate_email", "linkedin"].map((icon) => (
                <a key={icon} className="w-8 h-8 rounded-full border border-slate-800 flex items-center justify-center hover:bg-primary transition-all text-slate-400 hover:text-white" href="https://www.linkedin.com/company/asauvia/?viewAsMember=true" aria-label={icon}>
                  {icon === "linkedin" ? (
